...
class SCOPeDataModule(LightningDataModule):
    ...
    def __init__(self, name, log_dir, data_dir, max_n_res, min_n_res, dataset_names, dataset_size, dataset_classes,
        ...
        # Optimization Note:
        # To achieve Genie 2 performance, upgrade 'dataset_names' to include AFDB (AlphaFold Database) clusters.
        # Filter for pLDDT > 80 and Length < 256/512.
    ...
    def setup(self, stage=None):
        ...
        if os.path.exists(dataset_filepath):
            ...
            filepaths = load_filepaths(self.data_dir, self.dataset_names, self.max_n_res, self.min_n_res,
                                       self.dataset_classes, self.dataset_size)
