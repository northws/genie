...
class T:
    ...
    # ... [Keep make_transform_from_reference] ...

    @staticmethod
    def make_transform_from_reference(n_xyz, ca_xyz, c_xyz, eps=1e-20):
        # (Assuming original implementation here, optimized implicitely by not touching logic but ensuring environment is correct)
        # Note: Ideally this function should also use @autocast(enabled=False) if used in model
        translation = -1 * c_xyz
        ...
        c_rots = rot_matmul(c2_rots, c1_rots)  # Corrected variable name c2_rot_matrix -> c2_rots
